...
const uint16_t PROGMEM keymaps[NUM_LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT_ergodox_pretty(
    ...
    KC_LCTL,        KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_LSFT,
    KC_LSFT,        KC_Z,           KC_X,           KC_C,           KC_B,           KC_V,           KC_HOME,                                        KC_END,         KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_BSLS,
    MO(_AL),        KC_LSFT,        KC_TRANSPARENT, LCAG(KC_NO),    LALT_T(KC_ESCAPE),                                                                                              RCTL_T(KC_COMMA),KC_SYSTEM_WAKE,KC_TRANSPARENT, MO(_CL),        MO(_SL),
                                                                                                    KC_WWW_BACK,    KC_WWW_FORWARD, KC_PGUP,        KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_PGDN,
                                                                                    KC_SPACE,       LGUI_T(KC_TAB), LGUI(KC_SPACE), KC_DELETE,      KC_ENTER,       KC_BSPC
  ),
  [_SL] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_PERC,        KC_CIRC,        KC_LBRC,        KC_AT,          KC_RBRC,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_1,           KC_2,           KC_3,           KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [_ML] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_MS_WH_LEFT,  KC_MS_WH_RIGHT, KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,KC_TRANSPARENT, QK_BOOT,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MPRV,        KC_MPLY,        KC_MNXT,                                                        KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_UP,       KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [_CL] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, UC_LINX,        UC_WINC,        UC_PGTK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
...
// clang-format off
const uint8_t PROGMEM ledmap[NUM_LAYERS][RGB_MATRIX_LED_COUNT][3] = {
